...
<head>
    ...
    <title>Entrada digital - {{ $event->name }}</title>
</head>
        ...
        <tr>
            <td align="center">
                ...
                <table width="480" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    {{-- ═══ HEADER — gradient ═══ --}}
                    <tr>
                        <td style="background: #0972d3; background: -webkit-linear-gradient(135deg, #0972d3 0%, #033160 100%); background: linear-gradient(135deg, #0972d3 0%, #033160 100%); padding: 32px 36px 28px; text-align: center;">
                    ...
                    <tr>
                        <td style="padding: 24px 36px 0;">
                            ...
                            <p style="margin: 0 0 24px; color: #687078; font-size: 14px; line-height: 1.5;">
                                Tu registro ha sido confirmado. Esta es tu entrada digital.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fb; border-radius: 14px; overflow: hidden;">
                                <tr>
                                    <td style="padding: 24px 20px 8px; text-align: center;">
                                        ...
                                        <p style="margin: 0; font-size: 30px; font-weight: 700; color: #0972d3; letter-spacing: 3px; font-family: 'SF Mono', 'Fira Code', 'Consolas', 'Courier New', monospace;">
                                            {{ $participant->registration_code }}
                                        </p>
                                    </td>
                                </tr>
                                {{-- Dashed inner separator --}}
                                <tr>
                    ...
                    <tr>
                        <td style="padding: 0 36px 28px;">
                            <p style="margin: 0 0 14px; font-size: 14px; font-weight: 700; color: #16191f;">Siguientes pasos</p>
                                ...
                                <tr>
                                    <td style="padding: 0 0 10px;">
                                        <table cellpadding="0" cellspacing="0"><tr>
                                            ...
                                            <td style="padding-left: 10px; font-size: 14px; color: #414d5c;">Guarda este correo como tu comprobante</td>
                                        </tr></table>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 0 10px;">
                                        <table cellpadding="0" cellspacing="0"><tr>
                                            ...
                                            <td style="padding-left: 10px; font-size: 14px; color: #414d5c;">Accede a Networking y crea tu PIN personal</td>
                                        </tr></table>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0;">
                                        <table cellpadding="0" cellspacing="0"><tr>
                                            ...
                                            <td style="padding-left: 10px; font-size: 14px; color: #414d5c;">Presenta tu QR en la entrada del evento</td>
                                        </tr></table>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 0 36px 28px; text-align: center;">
                            <a href="{{ $networkingUrl }}" style="display: inline-block; background: #0972d3; background: -webkit-linear-gradient(135deg, #0972d3, #065fad); background: linear-gradient(135deg, #0972d3, #065fad); color: #ffffff; text-decoration: none; padding: 14px 44px; border-radius: 12px; font-size: 15px; font-weight: 600;">
