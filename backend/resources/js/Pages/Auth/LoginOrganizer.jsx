...
export default function LoginOrganizer() {
    ...
    function submit(e) {
        e.preventDefault();
        post('/organizer/login', { onFinish: () => reset('password') });
    }

    return (
        <>
            <Head title="Iniciar sesion - Organizadores" />
                ...
                <div className="auth-content">
                    <div className="auth-card">
                        ...
                        <div className="auth-card__heading">
                            <h1 className="auth-card__title">Acceso organizadores</h1>
